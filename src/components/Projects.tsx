...
const projects = [
  { title:"To-Do List Application",type:"React, JavaScript, CSS, Vite",image:listImg },
  { title:"Student Management System",type:"React, TypeScript, Ant Design",image:studentImg },
  { title:"File Organizer Application",type:"React, TypeScript, CSS",image:fileImg }
];
...
function Projects(){
  ...
  const handleWheel=(e:React.WheelEvent)=>{
    e.preventDefault();
    setZoom(z=>{
      const next=e.deltaY<0?Math.min(z+.15,4):Math.max(z-.15,1);
      if(next===1)setPosition({x:0,y:0});
      return next;
    });
  };
